...
local old_logic = sys.call('grep "\\.netmask" /bin/config_generate > /dev/null') == 0
...
netmask:value("255.0.0.0")
	...
	ipaddr = section:taboption("general", DynamicList, "ipaddr", translate("IPv4 address"))
	ipaddr.datatype = "cidr4"
	ipaddr.placeholder = '192.168.1.1/24'

	ipaddr.write = function(self, section, value)
		DynamicList.write(self, section, value)
		map:del(section, "netmask")
	end
end
