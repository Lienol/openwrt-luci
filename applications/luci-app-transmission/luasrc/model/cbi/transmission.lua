...
local webinstalled = luci.model.ipkg.installed("transmission-web") or luci.model.ipkg.installed("transmission-web-control") or uci:get_first("transmission", "transmission", "web_home") 
local button = ""
